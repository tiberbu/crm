          ...
          <div class="flex h-full flex-col p-2">
            ...
            <Dropdown :options="brandDropdownOptions">
              <template #default="{ open }">
                ...
                >
                  <div
                    class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-blue-600 text-white text-sm font-bold select-none"
                  >
                    FC
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div
                      class="mt-1 text-sm leading-none text-ink-gray-7 truncate"
                    >
            ...
            <!-- Nav items -->
            <div
              class="-mx-2 mt-2 flex flex-1 flex-col gap-1 overflow-y-auto px-2"
            >
              <SidebarItem
              ...
              >
                <template #prefix>
                  <span
                    :class="[section.iconClass, 'size-4 text-ink-gray-7']"
                    aria-hidden="true"
                  />
                </template>
                <Tooltip
        ...
        <div class="flex-1 overflow-auto">
          <div class="mx-auto w-full max-w-screen-2xl px-6 py-5">
            <template v-if="activeSection === 'dashboard'"
              ><CrmDashboard @navigate="onNavigate"
            /></template>
            ...
            <template v-else-if="activeSection === 'orders'"
              ><Orders
            /></template>
            <template v-else-if="activeSection === 'invoices'"
              ><Invoices
            /></template>
              ...
              <div class="max-w-2xl space-y-8">
                <div>
                  ...
                  <p class="mt-0.5 text-sm text-ink-gray-5">
                    Manage how the Finance Cockpit looks and behaves.
                  </p>
                </div>
                <div class="space-y-3">
                  <div>
...
const fcLogo = markRaw({
  render: () =>
    h(
      ...
      {
        class:
          'flex h-5 w-5 items-center justify-center rounded bg-blue-600 text-white text-[8px] font-bold',
      },
      'FC',
    ),
})
...
const headerTitle = computed(() => {
  ...
  return (
    SIDEBAR_SECTIONS.find((s) => s.key === activeSection.value)?.label ??
    'Finance'
  )
})
