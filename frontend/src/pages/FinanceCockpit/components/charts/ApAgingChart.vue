<template>
  <div class="fc-ap-aging-chart">
    ...
    <div
      ...
      class="h-32 flex items-center justify-center text-sm text-gray-400"
    >
      No data
    </div>
    <div v-else class="space-y-2">
      ...
      >
        <span
          class="text-xs text-gray-500 dark:text-gray-400 w-14 flex-shrink-0"
          >{{ bucket.bucket }}</span
        >
        <div
...
const maxAmount = computed(() =>
  Math.max(...(props.data || []).map((b) => b.amount), 1),
)
