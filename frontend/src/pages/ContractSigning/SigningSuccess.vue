<template>
  <div
    class="w-full max-w-sm rounded-2xl bg-white p-8 text-center shadow-lg dark:bg-gray-800"
  >
    <!-- Success icon -->
    <div
    ...
    <!-- Contract reference -->
    <div
      class="rounded-lg border border-gray-100 bg-gray-50 p-4 text-left dark:border-gray-700 dark:bg-gray-800/50"
    >
      <dl class="space-y-2">
        <div>
    ...
    <p class="mt-6 text-xs text-gray-400 dark:text-gray-500">
      You may close this window. A copy of the executed contract will be sent to
      you once all parties have signed.
    </p>
  </div>
</template>
