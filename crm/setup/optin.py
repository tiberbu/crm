...
TEST_FACILITIES = [
	...
	{
		"mfl_code": "13232",
		"facility_name": "Coast General Teaching & Referral Hospital",
		"keph_level": "Level 5",
	},
...
DEMO_NETWORKS = [
	...
	},
	{
		...
		"_contact": {
			"contact_name": "Abubakr Irungu",
			"contact_email": "irungu@kns.co.ke",
			"contact_phone": "0700000005",
		},
	},
	{
		"slug": "bahari-health",
...
DEMO_FACILITIES = {
	...
	"covenant-health": [
		...
		{
			"mfl_code": "22007",
			"facility_name": "AIC Litein Mission Hospital, Kericho",
			"keph_level": "Level 3B",
		},
		{
			"mfl_code": "22008",
			"facility_name": "Kapsowar Mission Hospital, Elgeyo-Marakwet",
			"keph_level": "Level 3",
		},
		{
			"mfl_code": "22009",
			"facility_name": "Siloam Mission Hospital, Trans Nzoia",
			"keph_level": "Level 3",
		},
	...
	"apex-medical": [
		{
			"mfl_code": "22011",
			"facility_name": "Primus International Medical Centre, Westlands",
			"keph_level": "Level 4",
		},
		{
			"mfl_code": "22012",
			"facility_name": "Meridian Medical Centre, Upper Hill",
			"keph_level": "Level 3B",
		},
		{
			"mfl_code": "22013",
			"facility_name": "HealthCare International, Westlands",
			"keph_level": "Level 3B",
		},
		{
			"mfl_code": "22014",
			"facility_name": "St. Luke's Orthopaedics & Trauma Hospital, Nairobi",
			"keph_level": "Level 4",
		},
		{
			"mfl_code": "22015",
			"facility_name": "Resolution Health Centre, Upper Hill",
			"keph_level": "Level 3A",
		},
	],
	"crescent-health": [
	...
	"pinnacle-care": [
		...
		{
			"mfl_code": "22022",
			"facility_name": "Athi River Medical Centre, Machakos",
			"keph_level": "Level 3B",
		},
	...
	"bahari-health": [
		...
		{
			"mfl_code": "22028",
			"facility_name": "Harbour View Medical Centre, Mombasa",
			"keph_level": "Level 3",
		},
		{"mfl_code": "22029", "facility_name": "Tudor Medical Centre, Mombasa", "keph_level": "Level 3A"},
		{
			"mfl_code": "22030",
			"facility_name": "Mishomoroni Medical Centre, Mombasa",
			"keph_level": "Level 2",
		},
	],
	"highlands-health": [
		...
		{
			"mfl_code": "22032",
			"facility_name": "Rift Valley Medical Centre, Nakuru",
			"keph_level": "Level 3B",
		},
		{
			"mfl_code": "22033",
			"facility_name": "Eldoret Highlands Medical Centre, Uasin Gishu",
			"keph_level": "Level 3",
		},
		{
			"mfl_code": "22034",
			"facility_name": "Nyahururu Medical Centre, Laikipia",
			"keph_level": "Level 3A",
		},
		{
			"mfl_code": "22035",
			"facility_name": "Molo Cottage Medical Centre, Nakuru",
			"keph_level": "Level 2",
		},
	],
}
...
def _send_demo_invitation(slug, net_meta, site_url):
	...
	fac_rows = "".join(
		"<li>{} (KEPH {})</li>".format(f["facility_name"], f["keph_level"]) for f in facilities
	)
...
""".format(
	...
	try:
		...
		frappe.log_error(
			frappe.get_traceback(), "seed_demo_networks: invitation email failed for {}".format(slug)
		)
...
def ensure_default_terms():
	...
	try:
		...
		if active and active != DEFAULT_TC_TITLE and frappe.db.exists("Terms and Conditions", active):
			return
