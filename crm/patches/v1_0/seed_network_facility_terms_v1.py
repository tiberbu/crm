...
This creates a new Terms and Conditions document for an administrator to review;
it deliberately does not change CRM Opt-In Settings.active_tc_document.  The
template is kept as a static HTML asset so user-entered network and facility data
is supplied only at render time through the escaped Jinja context.
"""
...
def execute():
	"""Create the template once, without overwriting an administrator's copy."""
