...
def execute():
	...
	has_old_col = frappe.db.sql("SHOW COLUMNS FROM `tabSales Invoice` LIKE 'crm_quote'")
	has_new_col = frappe.db.sql("SHOW COLUMNS FROM `tabSales Invoice` LIKE 'crm_quotation'")
