...
def approve_onboarding(
	...
	if doc.approval_status in ("Approved", "Rejected"):
		frappe.throw("This onboarding request is already %s and cannot be updated." % doc.approval_status)
	...
	all_approved = (
		doc.network_approver_1_approved and doc.network_approver_2_approved and doc.tiberbu_approver_approved
	)
	any_approved = (
		doc.network_approver_1_approved or doc.network_approver_2_approved or doc.tiberbu_approver_approved
	)
...
def reject_onboarding(
	...
	return approve_onboarding(onboarding_request, approver_slot, reject=1, rejection_reason=rejection_reason)
